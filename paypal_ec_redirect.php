<?php
   ...
   if(isset($_POST["L_PAYMENTREQUEST_0_QTY0"])){
   		$PAYMENTREQUEST_0_ITEMAMT = intval($_POST["L_PAYMENTREQUEST_0_QTY0"])*floatval($_POST["L_PAYMENTREQUEST_0_AMT0"]);
		$_POST["PAYMENTREQUEST_0_ITEMAMT"] = strval($PAYMENTREQUEST_0_ITEMAMT);
		$_POST['PAYMENTREQUEST_0_AMT'] = strval(intval($_POST["L_PAYMENTREQUEST_0_QTY0"])*floatval($_POST["L_PAYMENTREQUEST_0_AMT0"])+floatval($_POST["PAYMENTREQUEST_0_TAXAMT"])+floatval($_POST["PAYMENTREQUEST_0_SHIPPINGAMT"])+floatval($_POST["PAYMENTREQUEST_0_HANDLINGAMT"])+floatval($_POST["PAYMENTREQUEST_0_INSURANCEAMT"])+floatval($_POST["PAYMENTREQUEST_0_SHIPDISCAMT"]));
   }
