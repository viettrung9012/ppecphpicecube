...
if form.getvalue("L_PAYMENTREQUEST_0_QTY0"):
	PAYMENTREQUEST_0_ITEMAMT = int(form.getvalue("L_PAYMENTREQUEST_0_QTY0"))*float(form.getvalue("L_PAYMENTREQUEST_0_AMT0"))
	form_fields['PAYMENTREQUEST_0_ITEMAMT'] = str(PAYMENTREQUEST_0_ITEMAMT)
	form_fields['PAYMENTREQUEST_0_AMT'] = str(int(form.getvalue("L_PAYMENTREQUEST_0_QTY0"))*(float(form.getvalue("L_PAYMENTREQUEST_0_AMT0")))+float(form.getvalue("PAYMENTREQUEST_0_TAXAMT"))+float(form.getvalue("PAYMENTREQUEST_0_SHIPPINGAMT"))+float(form.getvalue("PAYMENTREQUEST_0_HANDLINGAMT"))+float(form.getvalue("PAYMENTREQUEST_0_INSURANCEAMT"))+float(form.getvalue("PAYMENTREQUEST_0_SHIPDISCAMT")))
	...
	resArray = CallShortcutExpressCheckout (form_fields, returnURL, cancelURL) #calling SetExpressCheckout for PayPal Shortcut
   	...
   	if ack=="SUCCESS" or ack=="SUCCESSWITHWARNING":  #if SetExpressCheckout API call is successful
		...
		print "Content-type: text/html\n\n"
   		...
   		print form_fields['PAYMENTREQUEST_0_ITEMAMT']
   		print form_fields['PAYMENTREQUEST_0_AMT']
